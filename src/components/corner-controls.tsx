...
import { IS_WEB, RELEASES_URL, REPO_URL } from "@/utils/site";

/** GitHub's mark (Octicons, MIT); the icon set carries no brand icons. */
...
const ExternalIconLink: React.FC<{
  href: string;
  label: string;
  testId: string;
  children: React.ReactNode;
}> = ({ href, label, testId, children }) => (
  <a
    href={href}
    target="_blank"
...
/** Bottom-right cluster: the theme switch everywhere, source and download links on the web. */
